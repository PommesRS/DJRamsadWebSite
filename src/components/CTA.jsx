...
export default class CTA extends React.Component {
  ...
  render(){
    return(
      <section className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} hover-effect2 relative overflow-hidden sm:flex-row flex-col gap-5 border-t-4 border-[#4F228D] box-shadow-2 rounded-3xl bg-black-gradient-2 box-shadow-2`}>
